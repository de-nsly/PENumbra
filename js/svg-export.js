/* ================================================================
   ...
   SVG from the worker's result), and the final export-to-.svg-file
   handler. The segment post-processing onResult runs the worker's
   output through is chain.js.
...
import { accumulatePathStats, appendContourPathD, appendCreasePathD, buildChainedPathD } from './chain.js';
